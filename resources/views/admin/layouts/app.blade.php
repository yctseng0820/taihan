      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          <li class="treeview active">
            <a href="#">
              <i class="fa fa-dashboard"></i> <span>產品類別</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="{{  route('category.index'  )}}"><i class="fa fa-circle-o"></i> 產品類別列表</a></li>
              <li class=""><a href="{{  route('category.create'  )}}"><i class="fa fa-circle-o"></i> 產品類別添加</a></li>
            </ul>
          </li>
