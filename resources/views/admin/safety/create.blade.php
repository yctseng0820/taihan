...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="{{  route('safety.index')  }}"><i class="fa fa-dashboard"></i> 安全建議列表</a></li>
        <li class="active">安全建議添加</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="{{route('safety.store')}}" enctype="multipart/form-data">
            {{  csrf_field()  }}
              <div class="box-body">
